...
export default function EmailOtpPage({ onBack, email }: EmailOTPVerificationProps) {
  ...
  const handleSubmit = () => {
    ...
    if (otpCode.length === 4) {
      console.log('Submitted Email OTP:', otpCode);
    }
  };
        ...
        <div className="text-center">
            ...
            <div className="flex flex-col items-center mb-2">
                ...
                <h1 className="text-xl md:text-2xl font-serif mb-4">
                    Please enter 4-digit code we sent to your email
                </h1>
                {email && (
